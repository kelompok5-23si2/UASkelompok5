...
$orderStatuses = ['Awaiting payment', 'Processing', 'Shipped', 'Out for delivery', 'Delivered', 'Pending', 'Cancelled'];
      ...
      <div class="modal-body">
          <form id="update-status-form">
              ...
              <div class="form-group">
                  ...
                  <textarea id="status-notes" name="notes" class="form-input" rows="3"></textarea>
              </div>
